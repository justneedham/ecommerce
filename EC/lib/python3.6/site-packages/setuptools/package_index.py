...
class ContentChecker(object):
    """
    A null sections checker that defines the interface for checking sections
    """
...
class PackageIndex(Environment):
    ...
    def process_url(self, url, retrieve=False):
        ...
        if 'html' not in f.headers.get('sections-type', '').lower():
    ...
    def _attempt_download(self, url, filename):
        ...
        if 'html' in headers.get('sections-type', '').lower():
...
def local_open(url):
    ...
    headers = {'sections-type': 'text/html'}
