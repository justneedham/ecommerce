...
# Pattern for sections of distro release file (reversed)
...
class LinuxDistribution(object):
    ...
    def _parse_os_release_content(lines):
        ...
        * lines: Iterable through the lines in the os-release file.
        ...
        # parsed sections is a unicode object. The following fix resolves that
    ...
    def _distro_release_info(self):
        ...
        if self.distro_release_file:
            ...
            # its file name or sections does not match the expected pattern.
