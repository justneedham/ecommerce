...
class WorkingSet(object):
    ...
    def _build_master(cls):
        ...
        try:
            ...
            # The ecommerceapp program does not list any requirements
            return ws
...
def split_sections(s):
    """Split a string or iterable thereof into (section, sections) pairs

    Each ``section`` is a stripped version of the section header ("[section]")
    and each ``sections`` is a list of stripped lines excluding blank lines and
